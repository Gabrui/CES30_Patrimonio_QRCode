class CategoriasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @categoria.save
        format.html { redirect_to @categoria, notice: 'Uma nova categoria foi criada.' }
  ...
  def update
    respond_to do |format|
      if @categoria.update(categoria_params)
        format.html { redirect_to @categoria, notice: 'A categoria foi atualizada.' }
  ...
  def destroy
    @categoria.destroy
    respond_to do |format|
      format.html { redirect_to categorias_url, notice: 'A categoria foi apagada.' }
